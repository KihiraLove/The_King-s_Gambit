...
{
    private readonly float back_boundary = 14.5f;
    private readonly float front_boundary = -2f;
    private readonly float left_boundary = -1.5f;
    private readonly float right_boundary = 8.5f;
